...
poll_vpn_status() {
  ...
  vpnStatus=`kubectl exec -it $podName -- curl -s -d'<rpc><show><message-vpn><vpn-name>default</vpn-name></message-vpn></show></rpc>' -u admin:admin http://localhost:8080/SEMP | grep local-status | grep Up`
